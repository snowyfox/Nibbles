...
// Added for Nibbles: set the microphone (ES7210) input gain after the codec is open.
esp_err_t bsp_extra_codec_set_in_gain(float gain_db)
{
    return esp_codec_dev_set_in_gain(record_dev_handle, gain_db);
}
